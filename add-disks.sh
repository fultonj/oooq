...
# Time-stamp:              <2017-01-12 10:59:02 jfulton> 
# -------------------------------------------------------
test "$(whoami)" != 'stack' \
...
rm -f ceph_0-osd-*
for i in b c d e; do 
  qemu-img create -f qcow2 -o preallocation=metadata ceph_0-osd-$i.qcow2 50G;
  virsh attach-disk ceph_0 --source /home/stack/.quickstart/pool/ceph_0-osd-$i.qcow2 --target vd$i --persistent
done
qemu-img create -f qcow2 -o preallocation=metadata ceph_0-osd-journal.qcow2 50G; 
