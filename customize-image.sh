...
virt-customize \
    ...
    --run-command "yum -y install https://copr-be.cloud.fedoraproject.org/results/tendrl/tendrl/epel-7-x86_64/00520121-tendrl-node-agent/tendrl-node-agent-1.2.1-1.el7.centos.noarch.rpm" \
